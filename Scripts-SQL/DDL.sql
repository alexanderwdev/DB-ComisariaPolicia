...
CREATE TABLE INVOLUCRAR_T (
    ...
    CONSTRAINT FK_INVT_TES FOREIGN KEY (dniTestigo) REFERENCES TESTIGO(dni),
    CONSTRAINT FK_INVT_CAS FOREIGN KEY (numCaso) REFERENCES CASO (numCaso)
);
...
CREATE TABLE INVOLUCRAR_V (
    ...
    CONSTRAINT FK_INVV_VIC FOREIGN KEY (dniVictima) REFERENCES VICTIMA(dni),
    CONSTRAINT FK_INVV_CAS FOREIGN KEY (numCaso) REFERENCES CASO (numCaso)
);    
...
CREATE TABLE INVOLUCRAR_S (
    ...
    CONSTRAINT FK_INVS_SOS FOREIGN KEY (dniSospechoso) REFERENCES SOSPECHOSO(dni),
    CONSTRAINT FK_INVS_CAS FOREIGN KEY (numCaso) REFERENCES CASO (numCaso)
